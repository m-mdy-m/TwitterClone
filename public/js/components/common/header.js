...
export default function Header({  profile='/assets/images/profilePic.png', username="m__mdy__m",id=''}={}) {
  return `
            ...
            <!-- Navigation Mobile -->
            <div id="nav-mobile" data-id="${id}" class="mobile:header__navigation-bg tablet:header__navigation-bg-transparent  mobile:fixed tablet:flex tablet:flex-col tablet:relative tablet:h-full tablet:left-0 mobile:top-0 mobile:-left-[100rem] mobile:p-5 tablet:p-0">
                ...
                ${MobileNavigation({ isAuth, profile, username})}
                <!-- Navigation Menu -->
