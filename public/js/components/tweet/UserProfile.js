...
export function UserProfile({ username, profile, className }) {
  ...
  <div class="container__profile-users flex ">
      ...
      <div class="bg-gradient-to-tr from-[#222224] to-[#262629] rounded-full hover:z-20 profile-user flex justify-center items-center border border-[#403e42] shadow-lg cursor-pointer duration-100 transition-all hover:scale-105">
