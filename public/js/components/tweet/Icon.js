export function Icon({ src, alt, className =  "", id = "",styleIcon="",display='hidden'}) {
  return `
    <div class="${className} relative flex justify-center icons mr-4 icon-container transform transition duration-150 hover:scale-105">
      ...
      <p class="${display} absolute -bottom-1 -right-1 text-[#5c6065] rounded-full flex items-center justify-center text-[10px]"></p>
    </div>
    `;
}