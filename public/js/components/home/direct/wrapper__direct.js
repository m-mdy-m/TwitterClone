export function  template_direct({bio,username,profile}){
    return `
    <div class="w-full my-2 p-2 px-4  delay-75 bg-[#11101076] hover:ml-2 hover:scale-105  hover:bg-[#262525a1] cursor-pointer transition-all rounded-r-lg flex justify-start items-center border-b border-[#252424]">
    <div class="w-12 h-12">
